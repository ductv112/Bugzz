...
| 05-02-NN | 02 (ThermalMonitor + sticker infra + RecordingState) | 1 | VID-08 + MOD-07 architectural | T-05-04, T-05-05, T-05-06 | unit + Robolectric | `./gradlew :app:testDebugUnitTest --tests "*ThermalMonitor* *StickerState* *StickerRenderer* *InsectFilterViewModel*"` | ❌ W0 → ✅ W1 | ⬜ |
| 05-03-NN | 03 (VideoRecorder + CameraController recording API + RecordingState lifecycle) | 2 | VID-01..06, VID-09, VID-10 | T-05-01, T-05-02, T-05-03, T-05-07 | unit + Robolectric | `./gradlew :app:testDebugUnitTest --tests "*VideoRecorder* *CameraControllerTest*recording* *CameraViewModelTest*onRecord*"` | ❌ W0 → ✅ W2 | ⬜ |
| 05-04-NN | 04 (CameraScreen Record button + indicator + AlertDialog + lock-during-record + extracted RecordButton/RecordingIndicator) | 3 | VID-07, VID-09, VID-10 | T-05-04 | unit + manual device | 05-HANDOFF + VM tests | ❌ W0 → ✅ W3 | ⬜ |
| 05-05-NN | 05 (InsectFilterScreen — consumes Plan 05-04 extracted composables) | 4 | MOD-03..06 | T-05-04, T-05-06 | unit + manual device | 05-HANDOFF + InsectFilterViewModelTest | ❌ W0 → ✅ W4 | ⬜ |
| 05-06-NN | 06 (Nav rewire + HomeScreen Insect Filter button enable + stub delete) | 5 | (integration only — no new REQs) | (none) | unit + manual device | 05-HANDOFF integration step | ❌ W0 → ✅ W5 | ⬜ |
| 05-07-NN | 07 (Tasks 1-4: Clean build + 05-HANDOFF runbook + device checkpoint + post-PASS close-out) | 6 | All Phase 5 reqs device-verified | T-05-01..07 | manual (device) | `./gradlew :app:assembleDebug` + 05-HANDOFF.md sign-off | ❌ W0 → ✅ W6 | ⬜ |
...
| VID-09 | BackHandler intercepts back press during recording; AlertDialog shown; Discard → recording.stop() + delete pending file. Lock UI behavior (picker alpha + flip disabled) covered by Decision D-23 + must_haves of Plan 05-04 + 05-05; no separate REQ ID. | unit (state) + manual device | `./gradlew :app:testDebugUnitTest --tests "*CameraViewModelTest*onDiscardRecording*"` + 05-HANDOFF | ❌ W0 — extend |
